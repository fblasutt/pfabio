...
def q(pt):
    ...
    return [((sh1-.1984)/.1984),((shpo-.1986)/.1986),((sh_min-.256)/.256),((eff_h- 2.317)/ 2.317),((eff_e-.064)/.064),((s_hl-7833)/7833)]#,((eff_full-0.045)/0.045),((eff_nomarg+0.115)/0.115)]#,((sh_hl-6108)/6108)]#,((eff_marg+0.115)/0.115)]#+((0.099-eff_e)/0.099)**2
...
xc=np.array([ 0.40706012,  0.03525281, -0.51941101,  0.00186123,  1.60048109, 0.03695673])
...
xl=np.array([0.05,-0.8,-0.8,-0.07,0.0001,0.0])
